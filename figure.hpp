...
protected:
    ...
    double _volume;
public:
    Figure(): _colour(), _volume(0.0) {};
    Figure(const Vec3d& color): _colour(color), _volume(0.0) {};
...
public:
    Box() = default;
    Box(const Vec3d& A, const Vec3d& B, const Vec3d& colour): Figure(colour), _A(A), _B(B) {};
